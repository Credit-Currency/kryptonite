...
uint256 hashGenesisBlock("0xa155faf1d6ae65994025431c488bd95c5447fe31563771b6324502d4995ae2db");
...
const string strMessageMagic = "Kryptonite Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Kryptonite: 1 days
static const int64 nTargetSpacing = 63; // Kryptonite: 1 min approx
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal kryptonite miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Kryptonite", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x305a3e524a0f861106a051361e58d618cc3b97bf3e1638dc5db796822a664f1a");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "premining is happening sat 8th Feb 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392476028;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 388905788;

        if (fTestNet)
        {
            block.nTime    = 1391881226;
            block.nNonce   = 386430816;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x18d336a7ee2c4127d9d8ca97e410419c6ab60738908ab5fac23342cd65362795"));
